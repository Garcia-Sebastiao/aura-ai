...
export function Sidebar({
  ...
  return (
    <div
      ref={sidebarRef}
      className={cn(
        "w-full fixed shadow-xl transition-all lg:shadow-none flex max-w-84 h-dvh dark:bg-background bg-white lg:bg-transparent z-100 lg:z-auto lg:sticky top-0",
